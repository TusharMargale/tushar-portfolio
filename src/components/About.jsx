        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="mt-6 flex flex-col gap-4">
              ...
              <div className="glass p-6 rounded-xl font-mono text-sm overflow-x-auto text-gray-300">
                <span className="text-pink-500">const</span> <span className="text-blue-400">currentMission</span> = {'{'}
                <br/>
                &nbsp;&nbsp;learning: <span className="text-green-400">"Advanced System Design"</span>,
                <br/>
                &nbsp;&nbsp;building: <span className="text-green-400">"Enterprise Applications"</span>,
                <br/>
                &nbsp;&nbsp;exploring: <span className="text-green-400">"Cloud Technologies"</span>,
                <br/>
                &nbsp;&nbsp;goal: <span className="text-green-400">"Become a Solution Architect"</span>
                <br/>
                {'}'};
              </div>
            </div>
